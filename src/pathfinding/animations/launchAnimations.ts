...
function launchAnimations(
      ...
      if (index === nodes.length) {
        if (object) {
          ...
          if (success) {
             ...
             *
             * TODO
             * set board.target className to visitedTargetNodeBlue if not equal visitedTargetNodeBlue
             *
             */
        ...
        if (object) {
           ...
           *
           * TODO
           * set board.start className to visitedStartNodePurple if not equal visitedStartNodePurple
           *
           */
          // if (
          //   document.getElementById(board.start).className !==
  ...
  function change(currentNode, previousNode = null, bidirectional = null) {
    /**
     *
     * TODO
     * get currentNode className
     *
     */
    ...
    if (previousNode) {
       ...
       *
       * TODO
       * get className previousHTMLNode
       *
       */
      let previousHTMLNode = { className: "" };
  ...
  function shortestPathChange(currentNode, previousNode = null) {
    /**
     *
     * TODO
    ...
    if (previousNode) {
       ...
       *
       * TODO
       * set className board.start and remove attr style
       *
       */
