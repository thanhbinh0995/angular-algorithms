...
export default class Board {
  ...
  public drawShortestPathTimeout(targetNodeId, startNodeId, type, object) {
    let board = this;
    let currentNode;
    let secondCurrentNode;
  ...
  public clearPath(clickedButton) {
    if (clickedButton) {
    ...
    Object.keys(this.nodes).forEach(id => {
       ...
       *
       * TODO
       * set status and className of current node with id
       *
       */
  ...
  public clearWeights() {
    Object.keys(this.nodes).forEach(id => {
       ...
       *
       * TODO
       * reset current node if weigth equals 15
       *
       */
  ...
  public redoAlgorithm = function() {
    this.clearPath();
    this.instantAlgorithm();
  };

  public reset(objectNotTransparent) {
    this.nodes[this.start].status = "start";
    /**
     *
     * TODO
     * set start node className
     *
     */
  ...
  public resetHTMLNodes() {
    /**
     *
     * TODO
     * reset start and target className
     *
     */
  ...
  public toggleTutorialButtons() {
     ...
     *
     * TODO
     * set tutorial hidden with skipButton clicked
     *
     */
    ...
    //     if (this.counter < 9) this.counter++;
    //     nextPreviousClick();
    //     this.toggleTutorialButtons();
    //   };
    // }
  ...
  public toggleButtons() {
    ...
    if (!this.buttonsOn) {
       ...
       *
       * TODO
       * handle adjustFast, adjustAverage, adjustSlow, startStairDemonstration
       *
       */
      ...
      //     (document.documentElement.clientHeight - navbarHeight - textHeight) /
      //       28
      //   );
       ...
       *
       * TODO
       * disable onclick event in button
       *
       */
      // this.buttonsOn = false;
       ...
       *
       * TODO
       * set disable clasname navigator
       *
       */
      // document.getElementById("adjustFast").className =
      //   "navbar-inverse navbar-nav disabledA";
